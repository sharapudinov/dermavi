...
use App\Core\Product\FilterField\PriceFilter;
...
/**
 * Class PriceFilterField
 *
 * @method PriceFilter getFilterField
 * @package App\Core\Product\FilterField\Facet
 */
class PriceFilterField extends AbstractRangeFacetFilterField
{
    /** @var string|FilterFieldInterface */
    protected $filterFieldInstance = PriceFilter::class;

    /** @var string Код идентификации поля */
    protected $filterFieldDtoCode = 'prices';
