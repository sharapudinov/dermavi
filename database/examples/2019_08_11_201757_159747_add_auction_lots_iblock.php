...
/**
 * Миграция для создания инфоблока "Лот аукциона"
 * Class AddAuctionLotsIblock20190811201757159747
 */
class AddAuctionLotsIblock20190811201757159747 extends BitrixMigration
{
    /** @var string $iblockCode - Символьный код ИБ */
    private $iblockCode = 'auction_lot';
    ...
    public function up()
    {
        ...
        $auctionLotIblockId = (new CIBlock)->Add([
            ...
            'DETAIL_PAGE_URL' => '#SITE_DIR#/auctions/lots/#CODE#/',
            'SITE_ID' => ['s1', 's2', 's3']
        ]);
