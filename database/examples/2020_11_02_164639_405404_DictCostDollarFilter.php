...
class DictCostDollarFilter20201102164639405404 extends BitrixMigration
{
    /**
     * Run the migration.
     *
    ...
    {
        $fields = [
            'NAME'       => 'DictCostDollarFilter',
            'TABLE_NAME' => 'dict_cost_dollar_filter',
        ];
    ...
    {
        $highloadBlockId = HLblock::getByTableName('dict_cost_dollar_filter')['ID'];
