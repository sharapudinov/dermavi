 ...
 * Class AddAuctionsIblock20190811204335138299
 */
class AddAuctionsIblock20190811204335138299 extends BitrixMigration
{
    /** @var string $iblockCode - Символьный код ИБ */
    private $iblockCode = 'auction';
    ...
    public function up()
    {
        ...
        $auctionIblockId = (new CIBlock)->Add([
            ...
            'LIST_PAGE_URL' => '#SITE_DIR#/auctions/',
            'DETAIL_PAGE_URL' => '#SITE_DIR#/auctions/#CODE#/',
            'SITE_ID' => ['s1', 's2', 's3']
        ]);
        ...
        (new CIBlockProperty)->Add([
            ...
            'SORT' => '498',
            'IBLOCK_ID' => $auctionIblockId,
            'LINK_IBLOCK_ID' => AuctionRule::iblockId()
        ]);
        ...
        (new CIBlockProperty)->Add([
            ...
            'SORT' => '499',
            'IBLOCK_ID' => $auctionIblockId,
            'LINK_IBLOCK_ID' => AuctionRuleFile::iblockId()
        ]);
        ...
        (new CIBlockProperty)->Add([
            ...
            'SORT' => '508',
            'IBLOCK_ID' => $auctionIblockId,
            'LINK_IBLOCK_ID' => AuctionLot::iblockId()
        ]);
