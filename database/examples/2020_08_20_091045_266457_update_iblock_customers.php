...
class UpdateIblockCustomers20200820091045266457 extends BitrixMigration
{
...
Мы соблюдаем требования Федерального закона Российской Федерации «О противодействии легализации (отмыванию) доходов, полученных преступным путем, и финансированию терроризма» №115-ФЗ.',
        ...
        FAQ::create([
            ...
            'PROPERTY_VALUES' => [
                ...
                'ANSWER_RU' => [
                    'VALUE' => [
                        'TEXT' => 'Оплата за приобретаемые бриллианты осуществляется банковской картой на сайте, банковским переводом по выставленному счету или банковской картой в офисе компании. <a href="/customer-service/order-and-shipping/#order">Подробнее</a>',
                        'TYPE' => 'HTML',
                    ]
                ],
            ]
