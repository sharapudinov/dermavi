...
class AddHlVideoPart20181126173935155798 extends BitrixMigration
{
    /**
     * Run the migration.
     *
    ...
    {
        $fields = [
            'NAME' => 'TracingVideoPart',
            'TABLE_NAME' => 'tracing_video_part',
        ];
