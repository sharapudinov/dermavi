...
class CreateCadasDicts20181106165917044647 extends BitrixMigration
{

    public static function getListDicts(): array
    {
        return [
            [
                'NAME' => ucfirst(HL\Color::getDictID()),
                'NAME_RU' => 'Цвета',
                'TABLE_NAME' => HL\Color::getTableName(),
            ],
            [
                'NAME' => ucfirst(HL\Culet::getDictID()),
                'NAME_RU' => '',
                'TABLE_NAME' => HL\Culet::getTableName(),
            ],
            [
                'NAME' => ucfirst(HL\Factory::getDictID()),
                'NAME_RU' => '',
                'TABLE_NAME' => HL\Factory::getTableName(),
            ],
            [
                'NAME' => ucfirst(HL\Fluor::getDictID()),
                'NAME_RU' => '',
                'TABLE_NAME' => HL\Fluor::getTableName(),
            ],
            [
                'NAME' => ucfirst(HL\Form::getDictID()),
                'NAME_RU' => '',
                'TABLE_NAME' => HL\Form::getTableName(),
            ],
            [
                'NAME' => ucfirst(HL\Intensity::getDictID()),
                'NAME_RU' => '',
                'TABLE_NAME' => HL\Intensity::getTableName(),
            ],
            [
                'NAME' => ucfirst(HL\Ownership::getDictID()),
                'NAME_RU' => '',
                'TABLE_NAME' => HL\Ownership::getTableName(),
            ],
            [
                'NAME' => ucfirst(HL\Persona::getDictID()),
                'NAME_RU' => '',
                'TABLE_NAME' => HL\Persona::getTableName(),
            ],
            [
                'NAME' => ucfirst(HL\Polish::getDictID()),
                'NAME_RU' => '',
                'TABLE_NAME' => HL\Polish::getTableName(),
            ],
            [
                'NAME' => ucfirst(HL\Qual::getDictID()),
                'NAME_RU' => '',
                'TABLE_NAME' => HL\Qual::getTableName(),
            ],
            [
                'NAME' => 'QualityGroups',
                'NAME_RU' => '',
                'TABLE_NAME' => HL\Quality::getTableName(),
            ],
            [
                'NAME' => ucfirst(HL\Size::getDictID()),
                'NAME_RU' => '',
                'TABLE_NAME' => HL\Size::getTableName(),
            ],
            [
                'NAME' => ucfirst(HL\Symmetry::getDictID()),
                'NAME_RU' => '',
                'TABLE_NAME' => HL\Symmetry::getTableName(),
            ],
        ];
    }
    ...
    {
        foreach (static::getListDicts() as $dict) {
            $highloadBlockId = HLblock::getByTableName($dict['TABLE_NAME'])["ID"];
