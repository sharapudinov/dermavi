...
class AutoAddIblockElementPropertyDescriptionRuToIb70020200617154106128100 extends BitrixMigration
{
    /**
     * Run the migration.
     *
  ...
  array (
    ...
    {
        $id = $this->getIblockPropIdByCode('DESCRIPTION_RU', AuctionPBLot::iblockId());
