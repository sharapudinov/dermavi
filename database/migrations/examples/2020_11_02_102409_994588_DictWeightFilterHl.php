...
class DictWeightFilterHl20201102102409994588 extends BitrixMigration
{
    /**
     * Run the migration.
     *
    ...
    {
        $fields = [
            'NAME'       => 'DictWeightFilter',
            'TABLE_NAME' => 'dict_weight_filter',
        ];
    ...
    {
        $highloadBlockId = HLblock::getByTableName('dict_weight_filter')['ID'];
