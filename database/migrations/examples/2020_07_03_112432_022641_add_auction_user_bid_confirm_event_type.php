 ...
 * Class AddAuctionUserBidConfirmEventType20200703112432022641
 */
class AddAuctionUserBidConfirmEventType20200703112432022641 extends BitrixMigration
{
    /** @var string Символьный код события */
    private const EVENT_NAME = 'AUCTION_USER_BID_CONFIRM';
    ...
    public function up()
    {
        $resultType = EventTypeTable::add([
            'fields' => [
                ...
                'NAME' => 'Аукцион: подтверждение ставки',
        ...
        $resultMessage = EventMessageTable::add([
            'fields' => [
                ...
                'EMAIL_TO' => '#EMAIL_TO#',
                'CC' => '',
                'SUBJECT' => 'Аукцион: подтверждение ставки',
                'BODY_TYPE' => 'html',
                'MESSAGE' => "<?php  
                    EventMessageThemeCompiler::includeComponent('email.dispatch:auction.user.bid_confirm', '', [
                    'user_id' => #USER_ID#,
                    'lot_id' => #LOT_ID#,
        ...
        $resultMessage = EventMessageTable::add([
            'fields' => [
                ...
                'EMAIL_TO' => '#EMAIL_TO#',
                'CC' => '',
                'SUBJECT' => 'Auction: bid confirmation',
                'BODY_TYPE' => 'html',
                'MESSAGE' => "<?php 
                    EventMessageThemeCompiler::includeComponent('email.dispatch:auction.user.bid_confirm', '', [
                    'user_id' => #USER_ID#,
