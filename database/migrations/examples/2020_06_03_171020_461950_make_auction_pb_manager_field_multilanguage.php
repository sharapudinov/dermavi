 ...
 * Class MakeAuctionPbManagerFieldMultilanguage20200603171020461950
 */
class MakeAuctionPbManagerFieldMultilanguage20200603171020461950 extends BitrixMigration
{
    /**
     * Run the migration.
     *
    ...
    public function up()
    {
        ...
        $property = new Property(AuctionPB::iblockId());
