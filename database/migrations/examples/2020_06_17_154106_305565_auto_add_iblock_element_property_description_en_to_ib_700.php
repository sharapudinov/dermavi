...
class AutoAddIblockElementPropertyDescriptionEnToIb70020200617154106305565 extends BitrixMigration
{
    /**
     * Run the migration.
     *
  ...
  array (
    ...
    {
        $id = $this->getIblockPropIdByCode('DESCRIPTION_EN', AuctionPBLot::iblockId());
